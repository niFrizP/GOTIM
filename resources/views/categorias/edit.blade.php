                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="4"
                                class="mt-1 block w-full rounded border-gray-300 dark:bg-gray-700 dark:text-white">{{ old('descripcion', $categoria->descripcion) }}</textarea>
...
<!-- Sonríe, respira y avanza despacio. - Thich Nhat Hanh -->
