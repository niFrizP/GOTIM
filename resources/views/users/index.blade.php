                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-b p-2 space-x-2">
                                <a href="{{ route('users.show', $user->id) }}" class="text-gray-600 hover:underline dark:text-gray-300">Ver</a>
                                <a href="{{ route('users.edit', $user->id) }}" class="text-blue-500 hover:underline">Editar</a>
                                @if ($user->estado)
                                <button onclick="mostrarModal('{{ $user->id }}', '{{ $user->nombre }} {{ $user->apellido }}')" class="text-red-500 hover:underline">
                                    Inhabilitar
                                </button>
                                @else
